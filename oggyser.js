...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:OGGY SER OFC\n'
            + 'ORG:Owner OGGY;\n'
            + 'TEL;type=CELL;type=VOICE;waid=919544266274:+919544266274\n'
            + 'END:VCARD'
...
const vcard1 = 'BEGIN:VCARD\n'
            ...
            + 'FN:OGGY \n'
            + 'ORG:Co Owner OGGY;\n'
            + 'TEL;type=CELL;type=VOICE;waid=919605243185:+919605243185\n'
            + 'END:VCARD'
...
memberLimit = 1
ban = []
premium = ["919544266274@s.whatsapp.net","919605243185@s.whatsapp.net"]
...
💮 WELCOME 💮`
				...
				teks = `*_「 ᴅᴇᴍᴏᴛᴇ ᴅᴇᴛᴇᴄᴛᴇᴅ 」_*\n@${num.split('@')[0]} ᴍᴇʜ ᴍᴏᴏɴᴊɪ ʜᴇʜᴇ...ʏᴏᴜ ᴀʀᴇ ᴅᴇmᴏᴛᴇᴅ ᴀs ᴍᴇᴍʙᴇʀ`
				let buff = await getBuffer(ppimg)
				denz.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["919544266274@s.whatsapp.net","15749993995@s.whataapp.net"] // owner number ubah aja
...
case 'husbu':
     ...
     if (budy.includes("Hallo")){
      ...
      if (budy.includes("halo")){
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_OGGY SER_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
   if (budy.includes("hai")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/AUD-20210318-WA2129.mp3')
    ...
    if (budy.includes("Oggy")){
        ...
        if (budy.includes("91954466274")){  // respon tag ubah aja
        reply(`OI *${pushname2}*, ᴀʏɪsʜ ɴᴛʜɪɴᴀ ɴᴛᴇ Oggy  ɴᴇ ᴛᴀɢ ᴄʜʏɪᴛʜᴇ!`)
        const d = fs.readFileSync('./sticker/tag.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_OGGY SER_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("Oggy sir")){  // respon tag ubah aja
        reply(`*${pushname2}*, enthina nte oggy ne vilikune ?`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_OGGY SER_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("Oggy kutta")){  // respon tag ubah aja
        reply(`*${pushname2}*, enthina nte oggy ne vilikune ?`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_OGGY SER_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("Oggy ser")){  // respon tag ubah aja
        reply(`*${pushname2}*, ɴɢᴀᴘᴀɪɴ ᴄᴀʟʟɪɴɢ² ᴏᴡɴᴇʀ ᴏɴʟʏ?`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_OGGY SER_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("Oggy")){  // respon tag ubah aja
        reply(`*${pushname2}*, ɴɢᴀᴘᴀɪɴ ᴄᴀʟʟɪɴɢ² ᴏᴡɴᴇʀ ᴏɴʟʏ?`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_OGGY SER_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        ...
        if (budy.includes("pavam")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/pavam.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : dj tapi boong", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("don")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/oggydon.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : dj tapi boong", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("thaloli")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/arjyuo.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : dj tapi boong", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
		if (budy.includes(`Thanks`)) {
                  ...
                  if (budy.includes(`Mukesh`)) {
                  reply(`Nee oke koode kalikunoda M*re *${pushname2}*`)
                  }
                  if (budy.includes(`mukesh`)) {
                  reply(`Nee oke koode kalikunoda M*re*${pushname2}*`)
                  }
                  if (budy.includes(`mukesh annen`)) {
                  reply(`Nee oke koode kalikunoda M*re *${pushname2}*`)
                  }
                  if (budy.includes(`Mukesh annen`)) {
                  reply(`Nee oke koode kalikunoda M*re *${pushname2}*`)
                  ...
                  if (budy.includes(`thanks`)) {
                  reply(`ʏᴏᴜR ᴡᴇʟᴄᴏᴍᴇ, sɪs *${pushname2}*, 𝙇𝙐𝘼 𝙎𝙀𝙍>-<`)
                  }
                  if (budy.includes(`makasih`)) {
                  reply(`ʏᴏᴜR ᴡᴇʟᴄᴏᴍᴇ, sɪs *${pushname2}*, 𝙇𝙐𝘼 𝙎𝙀𝙍>-<`)
                  }
