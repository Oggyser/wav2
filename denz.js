...
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:JOCKER BOT\n'
            + 'ORG:Owner JOCKER Bot;\n'
            + 'TEL;type=CELL;type=VOICE;waid=18:+91 8592026326\n'
            + 'END:VCARD'
       
const vcard1 = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:JOCKER UYIR\n'
            + 'ORG:Co Owner JOCKER Bot;\n'
            + 'TEL;type=CELL;type=VOICE;waid=919495585829:+91 9495585829\n'
            + 'END:VCARD'

prefix = "!"
name = "JOCKER BOT"
rdaftar = "𝐉𝐎𝐂𝐊𝐄𝐑 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑"
rmenu = "𝐉𝐎𝐂𝐊𝐄𝐑 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑"
botinfo = "𝐉𝐎𝐂𝐊𝐄𝐑 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑"
limitt = 999999999
memberLimit = 1
ban = []
premium = ["918592026326@s.whatsapp.net","919495585829@s.whatsapp.net"]
...
ᴛʏᴘᴇ ${prefix}daftar ᴛᴏ ɢᴇᴛ sᴛᴀʀᴛᴇᴅ ᴜsɪɴɢ ᴛʜᴇ ʙᴏᴛ`
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			const DnsBot = ["918592026326@s.whatsapp.net"] // ubah aja gapapa
			...
			const ownerNumber = ["918592026326@s.whatsapp.net","919495585829@s.whataapp.net"] // owner number ubah aja
			...
			const checkLimit = (sender) => {
				...
				try {
					const getmemex = groupMembers.length
					    ...
					    denz.sendMessage(from, `ᴍᴀᴀғ Jocker ʙᴏᴛ ᴛɪᴅᴀᴋ ʙɪꜱᴀ ᴍᴀꜱᴜᴋ ɢʀᴏᴜᴘ ᴋᴀʀɴᴀ ᴍᴇᴍʙᴇʀ ɢʀᴏᴜᴘ *${groupMetadata.subject}* ᴛɪᴅᴀᴋ ᴍᴇᴍᴇɴᴜʜɪ ʟɪᴍɪᴛ ᴍᴇᴍʙᴇʀ\n\nᴍɪɴɪᴍᴀʟ ᴍᴇᴍʙᴇʀ *${memberLimit}*`, text)
					setTimeout( () => {
		...
		setTimeout( () => {
		reply(`ᴍᴀᴀғ JOCKER ʙᴏᴛ ꜱᴇɢᴇʀᴀ ᴋᴇʟᴜᴀʀ ᴅᴀʀɪ ɢʀᴏᴜᴘ *${groupMetadata.subject}*`)
		}, 0)
		}
...
║wa.me/+916282670349
╙───々
 𝙄𝙉𝙎𝙏𝘼: https://www.instagram.com/__death_shifter_?r=nametag
╓───「 *_ʙᴏᴛ ɪɴғᴏ_* 」
║❏ ᴄʀᴇᴀᴛᴏʀ: 𝟒 𝟒 𝟒
║❏ ʀᴇᴄᴏᴅᴇ ʙʏ: 𝙹𝙾𝙲𝙺𝙴𝚁 ᴛᴇᴀᴍ
║❏ ᴘʀᴇғɪx: ${prefix}
...
case 'igpost': 				
				...
				if (!isUrl(args[0]) && !args[0].includes('www.instagram.com')) return reply('this is not JOCKER instagram url')
				ige = body.slice(8)
                                anu = await fetchJson(`https://onlydevcity.herokuapp.com/api/ig?url=${args[0]}&apikey=onlyonedeveloper`, {method: 'get'})
				buffer = await getBuffer(anu.result.url)
                                denz.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "𝐋𝐔𝐀 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('dnsnew.jpg')} } }})
				break
		case 'fakeaddress': 
				reply(`[❕] Loading`)
				...
				buffer = await getBuffer(anu.result.url)
				denz.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "𝐉𝐎𝐂𝐊𝐄𝐑 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('dnsnew.jpg')} } }, caption: 'Nih hasilnya kak...'})
				break 
				case 'hbd': 				
				if (args.length < 1) return reply(`where is the text, uncle?`)	
				ct = body.slice(4)
				...
				buffer = await getBuffer(anu.result.url)
				denz.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "J O C K E R 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('dnsnew.jpg')} } }, caption: 'Nih hasilnya kak...'})
				break
		case 'shine': 				
				if (args.length < 1) return reply(`where is the text, uncle?`)	
				ct = body.slice(6)
		...
		case 'cemetery': 				
				...
				buffer = await getBuffer(anu.result.url)
				denz.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://m#FF9500#FF00B4mg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": " 𝐉𝐎𝐂𝐊𝐄𝐑 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('dnsnew.jpg')} } }, caption: 'Nih hasilnya kak...'})
				break
		case 'royallock': 				
				if (args.length < 1) return reply(`where is the text, uncle?`)	
				ct = body.slice(10)
		...
		case 'onesilk': 				
				...
				buffer = await getBuffer(anu.result.url)
				denz.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "??𝐎𝐂𝐊𝐄𝐑 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('dnsnew.jpg')} } }, caption: 'Nih hasilnya kak...'})
				break
		case 'glowing': 				
				if (args.length < 1) return reply(`where is the text, uncle?`)
				ct = body.slice(8)
...
// last
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						denz.sendMessage(from, buffer, image, {quoted: mek, caption: 'JOCKER BOT UYIR'})
						fs.unlinkSync(ran)
					})
					await limitAdd(sender) 
					break 
  ...
  break
			...
			if (!isUser) return reply(mess.only.userB)
				...
				case 'info':
					...
					teks = `➽ *ɴᴀᴍᴀ ʙᴏᴛ* : ${me.name}\n➽ *ᴏᴡɴᴇʀ ʙᴏᴛ* : jockerUYIR\n➽ *ᴘʀᴇғɪx* : | ${prefix} |\n➽ *ᴛᴏᴛᴀʟ ʙʟᴏᴄᴋ* : ${blocked.length}\n➽ *ᴀᴄᴛɪᴠᴇ sɪɴᴄᴇ* : ${kyun(uptime)}\n➽ *ᴛᴏᴛᴀʟ ᴜsᴇʀ* : ${user.length} ᴜꜱᴇʀ\n➽ *ɪɴꜱᴛᴀɢʀᴀᴍ* :  https://www.instagram.com/__death_shifter_?r=nametag \n➽ *telegram* : https://t.me/I AM NOT IN\n➽ *ꜱᴘᴇᴄɪᴀʟ ᴛʜᴀɴᴋꜱ ᴛᴏ* :\n➽ JOCKER ᴜʏɪʀ\n➽ 𝟒 𝟒 𝟒`
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}burnpaper jocker`)
todi = body.slice(11)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}narutobanner jocker`)
nar = body.slice(14)
reply(mess.wait)
       ...
       exec(`wget ${anu1} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
            ...
            break  
				...
				case 'owner':
                 ...
                 denz.sendMessage(from, '*_ɪᴛs ᴛʜᴇ ᴄᴀᴋᴇ ɢɪʀʟs ᴍᴇᴀɴs ᴏᴡɴᴇʀ >-<_*',text, { quoted: mek} )
                 break
                case 'fitnah':
                 if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
         ...
         case 'lirik':
                ...
                if (args.length < 1) return reply(`Yang mau direport apaan? Contoh: #report fitur #hentai error`)
                    ...
                    denz.sendMessage('19152665341@s.whatsapp.net', options, text, {quoted: mek})
...
quoted: mek, caption: `Hasil Dari *${daerah}*`
  ...
  break
			    ...
			    if (!isUser) return reply(mess.only.userB)
					...
					mentions(`╔═══✪ Tag By *${pushname2}* ✪══`+ teks +'╚═══〘 *jJcker BOT* 〙═══', members_id, true)
					break
			    case 'mentionall':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
					...
					mentions(`╔══〘  *${body.slice(12)}*  〙✪══`+teks+'╚═〘 *JOCKER BOT* 〙', members_id, true)
					break
			    case 'kbbi':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
...
case 'husbu':
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("boong")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/boong.mp3')
		...
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/uyir.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/myr.webp')}}}})
        }
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/blknew.webp')}}}})
        }        
        if (budy.includes("poda")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/chadu.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/podanew.webp')}}}})
        }        
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/enjoy.webp')}}}})
        }        
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/getin.webp')}}}})
        }        
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/kundan.webp')}}}})
        }        
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/mone.webp')}}}})
        }        
        if (budy.includes("mrng")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/mrngz.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/good.webp')}}}})
        }        
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/myre.webp')}}}})
        }        
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/theri.webp')}}}})
        }        
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/hate.webp')}}}})
        }        
        if (budy.includes("uppu")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/uppu.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/uppu.webp')}}}})
        }
        if (budy.includes("andi")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/andi.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/andi.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_JOCKER 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/jget.webp')}}}})
        }
            if (budy.includes("keli")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/keli.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        ...
        if (budy.includes("18313533916")){  // respon tag ubah aja
		...
		if (budy.includes(`Thanks`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, Aliyo *${pushname2}*, 𝙹𝙾𝙲𝙺𝙴𝚁 ᴜʏɪʀ ʏᴏᴜ >-<`)
                  }
                  if (budy.includes(`Hai`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, Alio *${pushname2}*, 𝙹𝙾𝙲𝙺𝙴𝚁 ᴜʏɪʀ ʏᴏᴜ >-<`)
                  }
                  if (budy.includes(`Tq`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, Alia *${pushname2}*, 𝙹𝙾𝙲𝙺𝙴𝚁 ᴜʏɪʀ ʏᴏᴜ >-<`)
                  }
                  if (budy.includes(`Thx`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, Aliao *${pushname2}*, 𝙹𝙾𝙲𝙺𝙴𝚁 ᴜʏɪʀ ʏᴏᴜ >-<`)
                  }
                  if (budy.includes(`Oombiko`)) {
                  reply(`Erakam vakil kunjiju erikk *${pushname2}*`)
                  }
                  if (budy.includes(`Andi`)) {
                  reply(`cheetha parayale monu endi enn para *${pushname2}*`)
                  }
                  if (budy.includes(`Admin`)) {
                  reply(` 𝘼𝙙𝙢𝙞𝙣 𝙪𝙧𝙖𝙠𝙖𝙢 𝙖𝙝𝙣 𝙢𝙤𝙣𝙪 *${pushname2}*`)
                  }
                  ...
                  reply(`Morngz by Jocker*${pushname2}*`)
                  }
                  if (budy.includes(`thanks`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, alia *${pushname2}*, JOCKER ᴜʏɪʀ ʏᴏᴜ >-<`)
                  }
                  if (budy.includes(`Name`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, alia *${pushname2}*, JOCKER ᴜʏɪʀ ʏᴏᴜR NAME >-<`)
                  }
                  if (budy.includes(`tq`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, alia *${pushname2}*, JOCKER ᴜʏɪʀ ʏᴏᴜ >-<`)
                  }
                  ...
                  if (budy.includes(`Bot`)) {
                  reply(`ʜᴇʟʟᴏ alia *${pushname2}*, 𝙹𝙾𝙲𝙺𝙴𝚁 ʜᴇʀᴇ ᴄᴀɴ ʏᴏᴜ ʜᴇʟᴘ?  ᴛʏᴘᴇ *${prefix}menu* ʏᴇs ʙʀᴏᴛʜᴇʀ`)
                  }
			      if (budy.includes(`JOCKER`)) {
                  reply(`ʜᴇʟʟᴏ alia *${pushname2}*, 𝙹𝙾𝙲𝙺𝙴𝚁 ʜᴇʀᴇ ᴄᴀɴ ʏᴏᴜ ʜᴇʟᴘ?  ᴛʏᴘᴇ *${prefix}menu* ʏᴇs ʙʀᴏᴛʜᴇʀ`)
                  }
                  if (budy.includes(`Jocker`)) {
                  reply(`ʜᴇʟʟᴏ aliao *${pushname2}*, 𝙹𝙾𝙲𝙺𝙴𝚁 ʜᴇʀᴇ ᴄᴀɴ ʏᴏᴜ ʜᴇʟᴘ?  ᴛʏᴘᴇ *${prefix}menu* ʏᴇs ʙʀᴏᴛʜᴇʀ`)
                  }
                  }
