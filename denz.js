...
prefix = "!"
name = "JOCKER BOT"
rdaftar = "𝙅𝙊𝘾𝙆𝙀𝙍 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑"
rmenu = "𝙅𝙊𝘾𝙆𝙀𝙍 𝐔𝐘𝐈𝐑"
botinfo = "𝙅𝙊𝘾𝙆𝙀𝙍 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑"
limitt = 999999999
memberLimit = 1
ban = []
premium = ["918592026326@s.whatsapp.net","917907579731@s.whatsapp.net"]
	...
	denz.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `ʜᴇʟʟᴏ @${num.split('@')[0]}👋\nᴡᴇʟᴄᴏᴍᴇ ᴛᴏ OUR ɢʀᴏᴜᴘ..Chugikam Over Akaruth*${mdata.subject}*\n\n ────────────────
┏━━━━━━━━━━━━━━━
┃────「 *_ɪɴᴛʀᴏ_* 」─────
┗━━━━━━━━━━━━━━━

ᴛʏᴘᴇ ${prefix} ! Verify ᴛᴏ ɢᴇᴛ sᴛᴀʀᴛᴇᴅ ᴜsɪɴɢ ᴛʜᴇ ʙᴏᴛ`
				...
				teks = `*_「 ᴘʀᴏᴍᴏᴛᴇ ᴅᴇᴛᴇᴄᴛᴇᴅ 」_*\n@${num.split('@')[0]} 𝙼𝙾𝙽𝚄𝚂𝙴 𝙲𝙾𝙽𝙶𝚁𝙰𝚃𝚂 𝚈𝙾𝚄 𝙰𝚁𝙴 𝙽𝙾𝚆 𝙰𝙳𝙼𝙸𝙽`
				let buff = await getBuffer(ppimg)
				denz.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
				...
				teks = `*_「 ᴅᴇᴍᴏᴛᴇ ᴅᴇᴛᴇᴄᴛᴇᴅ 」_*\n@${num.split('@')[0]} 𝙼𝚎𝚑 𝚖𝚘𝚘𝚗𝚓𝚒 𝙷𝚘𝚘𝚖...𝙲𝙾𝙽𝙶𝚁𝙰𝚃𝚂 𝚈𝚘𝚞 𝙰𝚛𝚎 𝚍𝚎𝚖𝚘𝚝𝚎𝚍 𝚊𝚜 𝚖𝚎𝚖𝚋𝚎𝚛`
				let buff = await getBuffer(ppimg)
				denz.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
				...
				teks = `𝙾𝙺 ʙʏᴇ 𝙳𝙰 𝙼𝙾𝙽𝚄 @${num.split('@')[0]}👋\n𝙳𝙴𝙰𝚃𝙷 ⚰💀 ɪɴ ᴘᴇᴀᴄᴇ`
				let buff = await getBuffer(ppimg)
				denz.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '*👻 ᴡᴀɪᴛ 𝙲𝙷𝚈 𝙼𝙾𝙽𝚄...ᴘʀᴏᴄᴇssᴇᴅ ꇙꄲꄲꋊ...*',
				success: '*sᴜᴄᴄᴇss...*',
				error: {
				...
				only: {
					group: '*𝙼𝙾𝙾𝙽𝙹𝙸...sᴏʀʀʏ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ɪɴ ɢʀᴏᴜᴩ!*',
			...
			const ownerNumber = ["918592026326@s.whatsapp.net","917907579731@s.whataapp.net"] // owner number ubah aja
			...
			const checkLimit = (sender) => {
				...
				try {
					const getmemex = groupMembers.length
					    ...
					    denz.sendMessage(from, `ᴍᴀᴀғ 𝙹𝙾𝙲𝙺𝙴𝚁 ʙᴏᴛ ᴛɪᴅᴀᴋ ʙɪꜱᴀ ᴍᴀꜱᴜᴋ ɢʀᴏᴜᴘ ᴋᴀʀɴᴀ ᴍᴇᴍʙᴇʀ ɢʀᴏᴜᴘ *${groupMetadata.subject}* ᴛɪᴅᴀᴋ ᴍᴇᴍᴇɴᴜʜɪ ʟɪᴍɪᴛ ᴍᴇᴍʙᴇʀ\n\nᴍɪɴɪᴍᴀʟ ᴍᴇᴍʙᴇʀ *${memberLimit}*`, text)
					setTimeout( () => {
		...
		setTimeout( () => {
		reply(`ᴍᴀᴀғ 𝙹𝙾𝙲𝙺𝙴𝚁 ʙᴏᴛ ꜱᴇɢᴇʀᴀ ᴋᴇʟᴜᴀʀ ᴅᴀʀɪ ɢʀᴏᴜᴘ *${groupMetadata.subject}*`)
		}, 0)
		}
        ...
        if (adminNumber.includes(messagesLink)){
        	hasil = `        ────────────────
ʜᴇʏ *${pushname2}* ᴛʀʏ 𝙲𝙷𝚈 𝙼𝙾𝙽𝚄..ᴛʏᴘɪɴɢ *${prefix}menu*
        ────────────────`
...
case 'igpost': 				
				...
				buffer = await getBuffer(anu.result.url)
                                denz.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "𝙅𝙊𝘾𝙆𝙀𝙍 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('dnsnew.jpg')} } }})
				break
		case 'fakeaddress': 
				reply(`[❕] Loading`)
		...
		case 'rosegold': 				
				...
				buffer = await getBuffer(anu.result.url)
				denz.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "𝙅𝙊𝘾𝙆𝙀𝙍𝐁𝐎𝐓 𝐔𝐘𝐈𝐑", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('dnsnew.jpg')} } }, caption: 'Nih hasilnya kak...'})
				break
		case 'nature3d': 				
				if (args.length < 1) return reply(`where is the text, uncle?`)	
				ct = body.slice(9)
...
// last
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						denz.sendMessage(from, buffer, image, {quoted: mek, caption: 'JOCKERBOT UYIR'})
						fs.unlinkSync(ran)
					})
					await limitAdd(sender) 
					break 
...
quoted: mek, caption: `Hasil Dari *${daerah}*`
  ...
  break
			    ...
			    if (!isUser) return reply(mess.only.userB)
					...
					mentions(`╔═══✪ Tag By *${pushname2}* ✪══`+ teks +'╚═══〘 *ＪＯＣＫＥＲ BOT* 〙═══', members_id, true)
					break
			    case 'mentionall':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
					...
					mentions(`╔══〘  *${body.slice(12)}*  〙✪══`+teks+'╚═〘 *ＪＯＣＫＥＲ BOT* 〙', members_id, true)
					break
			    case 'kbbi':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (mentioned.length > 1) {
						...
						mentions(`Order received, @${mentioned[0].split('@')[0]} You Become an Admin in the Group..Monu ne Edmin ayi*${groupMetadata.subject}*`, mentioned, true)
						denz.groupMakeAdmin(from, mentioned)
					}
					break
				case 'delete':
...
case 'husbu':
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_ 𝙅𝙊𝘾𝙆𝙀𝙍 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("boong")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/boong.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙅𝙊𝘾𝙆𝙀𝙍 𝐁𝐎𝐓 𝐔𝐘𝐈𝐑_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
		...
		if (budy.includes(`Thanks`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, Aliyo *${pushname2}*, JOCKER ᴜʏɪʀ ʏᴏᴜ >-<`)
                  }
                  if (budy.includes(`Hai`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, Alio *${pushname2}*, JOCKER ᴜʏɪʀ ʏᴏᴜ >-<`)
                  }
                  if (budy.includes(`Tq`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, Alia *${pushname2}*, JOCKER ᴜʏɪʀ ʏᴏᴜ >-<`)
                  }
                  if (budy.includes(`Thx`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, Aliao *${pushname2}*, JOCKER ᴜʏɪʀ ʏᴏᴜ >-<`)
                  }
                  ...
                  reply(`Admin urangunnu pinne baa *${pushname2}*`)
                  }
                  ...
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, alia *${pushname2}*, 𝙹𝙾𝙲𝙺𝙴𝚁 ᴜʏɪʀ ʏᴏᴜR NAME >-<`)
                  }
                  if (budy.includes(`tq`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, alia *${pushname2}*, 𝙹𝙾𝙲𝙺𝙴𝚁 ᴜʏɪʀ ʏᴏᴜ >-<`)
                  }
			      ...
			      if (budy.includes(`JOCKER`)) {
                  reply(`ʜᴇʟʟᴏ alia *${pushname2}*, 𝙹𝙾𝙲𝙺𝙴𝚁 ʜᴇʀᴇ ᴄᴀɴ ʏᴏᴜ ʜᴇʟ𝙿?𝙽𝚃𝙷 𝚅𝙴𝙽𝙰𝙼 𝙼𝙾𝙽𝚄𝚂𝙴?  ᴛʏᴘᴇ *${prefix}menu* ʏᴇs ʙʀᴏᴛʜᴇʀ`)
                  }
                  if (budy.includes(`Bot`)) {
                  reply(`ʜᴇʟʟᴏ sɪs *${pushname2}*, 𝙹𝙾𝙲𝙺𝙴𝚁 𝙱𝙾𝚃 ʜᴇʀᴇ ᴄᴀɴ ʏᴏᴜ ʜᴇʟᴘ?  ᴛʏᴘᴇ *${prefix}menu* ʏᴇs ʙʀᴏᴛʜᴇʀ`)
                  }
