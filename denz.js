...
const vcard1 = 'BEGIN:VCARD\n'
            ...
            + 'TEL;type=CELL;type=VOICE;waid=918592026326:+91 8592026326\n'
            + 'END:VCARD'
...
ᴛʏᴘᴇ ${prefix} ! Verify ᴛᴏ ɢᴇᴛ sᴛᴀʀᴛᴇᴅ ᴜsɪɴɢ ᴛʜᴇ ʙᴏᴛ`
				...
				teks = `*_「 ᴅᴇᴍᴏᴛᴇ ᴅᴇᴛᴇᴄᴛᴇᴅ 」_*\n@${num.split('@')[0]} 𝙼𝚎𝚑 𝚖𝚘𝚘𝚗𝚓𝚒 𝙷𝚘𝚘𝚖...𝚈𝚘𝚞 𝙰𝚛𝚎 𝚍𝚎𝚖𝚘𝚝𝚎𝚍 𝚊𝚜 𝚖𝚎𝚖𝚋𝚎𝚛`
				let buff = await getBuffer(ppimg)
				denz.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["918592026326@s.whatsapp.net","8592026326@s.whataapp.net"] // owner number ubah aja
...
case 'husbu':
		...
		if (budy.includes(`Thanks`)) {
                  ...
                  if (budy.includes(`Jocker`)) {
                  reply(`ʜᴇʟʟᴏ sɪs *${pushname2}*, JOCKER ʜᴇʀᴇ ᴄᴀɴ ʏᴏᴜ ʜᴇʟᴘ?  ᴛʏᴘᴇ *${prefix}menu* ʏᴇs ʙʀᴏᴛʜᴇʀ`)
                  }
